...
from time_robust_forest import __version__
from time_robust_forest.example import hello
...
app = typer.Typer(
    ...
    help="Explores time information to train a robust random forest",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]time-robust-forest[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the time-robust-forest package.",
    ),
):
