...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r time_robust_forest/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg time_robust_forest tests/**/*.py
